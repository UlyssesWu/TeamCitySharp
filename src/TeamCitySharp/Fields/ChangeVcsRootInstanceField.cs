...
{
  public class ChangeVcsRootInstanceField : IField
  {
    #region Properties
    ...
    public static ChangeVcsRootInstanceField WithFields(PropertiesField properties = null,
                                          bool id = false,
                                          bool vcsName = false,
    ...
    {
      return new ChangeVcsRootInstanceField
      {
