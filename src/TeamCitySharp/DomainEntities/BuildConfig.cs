...
namespace TeamCitySharp.DomainEntities
{
    public class BuildConfig
    {
        ...
        [JsonProperty("templates")] public Templates Templates { get; set; }
        ...
        [JsonProperty("vcs-root-entries")] public VcsRootEntries VcsRootEntries { get; set; }

        [JsonProperty("steps")] public BuildSteps Steps { get; set; }

        [JsonProperty("agent-requirements")] public AgentRequirements AgentRequirements { get; set; }

        [JsonProperty("triggers")] public BuildTriggers Triggers { get; set; }

        [JsonProperty("settings")] public Properties Settings { get; set; }

        [JsonProperty("builds")] public BuildWrapper Builds { get; set; }

        [JsonProperty("investigations")] public InvestigationWrapper Investigations { get; set; }

        [JsonProperty("compatibleAgents")] public CompatibleAgents CompatibleAgents { get; set; }

        public static implicit operator Template(BuildConfig config)
        {
            return new Template(config.Id)
            {
                Href = config.Href,
                Name = config.Name,
